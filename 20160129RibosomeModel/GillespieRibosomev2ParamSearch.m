...
%ParamArray = [25,40,50,75,100]; %Number of Ribosomes per Gene
%ParamArray = [.01,.05,.1,.2,.5]; %kON Value
%ParamArray = [.001,.005,.01,.05,.1]; %alpha Value
%ParamArray = [.001,.005,.01,.05,.1]; %kB Value
ParamArray = [.1,.5,1,2,5]; %kOFF Value
