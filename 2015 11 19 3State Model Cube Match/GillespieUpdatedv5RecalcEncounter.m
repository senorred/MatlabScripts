...
%comparable numbers to cube 10% to 50% crowding
 VarArray = mean(BurstLengthmean,1);%[1,6,25]; %burst durations 
% %timebetween = [0.10594824,0.0866851,0.06852042]; %empty bursts removed
 timebetween = mean(BurstTimesBetweenmean,1); %empty bursts included
...
% set(gca,'XScale','log');
% set(gca,'YScale','log');
save 2StateRecalcEncounterData
%%
...
title('mRNA cv2 v Abundance From Recalc Encounters')
saveas(gcf,'mRNAcv2vAbundance2StateRecalc.jpg')
